# Lab 6: Kubernetes Networking and Troubleshooting
...
Ensure that you have completed [Lab 5](../lab5/README.md) and have the `node-secure-app` deployment running in your namespace.
