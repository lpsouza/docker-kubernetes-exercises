# Lab 4: Kubernetes Deployments in Multi-Tenant Environments
...
* The application image `node-secure-app:1.0.0` loaded or accessible by the cluster (built in [Docker Lab 2](../../docker/lab2/README.md)). Alternatively, you can use the image `localhost:5001/node-secure-app:1.0.0` if you configured the local registry in the [Registry Setup](../registry-setup/README.md).
